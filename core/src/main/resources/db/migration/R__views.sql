...
-- Dumping structure for view mtn_prod.active_and_future_stores
...
-- Dumping structure for view mtn_prod.active_stores_with_strengths
...
-- Dumping structure for view mtn_prod.average_sc_score
...
-- Dumping structure for view mtn_prod.avg_by_banner
...
-- Dumping structure for view mtn_prod.avg_by_banner_in_county
...
-- Dumping structure for view mtn_prod.avg_by_county
...
-- Dumping structure for view mtn_prod.avg_by_fit
...
-- Dumping structure for view mtn_prod.avg_by_fit_in_county
...
-- Dumping structure for view mtn_prod.most_recent_shopping_center_casing
...
-- Dumping structure for view mtn_prod.most_recent_shopping_center_survey
...
-- Dumping structure for view mtn_prod.most_recent_store_casing
...
-- Dumping structure for view mtn_prod.most_recent_store_model
...
-- Dumping structure for view mtn_prod.most_recent_store_status
...
-- Dumping structure for view mtn_prod.most_recent_store_survey
...
-- Dumping structure for view mtn_prod.most_recent_store_volume
...
-- Dumping structure for view mtn_prod.most_recent_store_volume_actual
...
-- Dumping structure for view mtn_prod.most_recent_store_volume_estimate
...
-- Dumping structure for view mtn_prod.most_recent_store_volume_projection
...
-- Dumping structure for view mtn_prod.most_recent_store_volume_reported
...
-- Dumping structure for view mtn_prod.most_recent_store_volume_third_party
...
-- Dumping structure for view mtn_prod.sc_condition_global_avg_score
...
-- Dumping structure for view mtn_prod.sc_condition_index
...
-- Dumping structure for view mtn_prod.sc_condition_score
...
-- Dumping structure for view mtn_prod.shopping_center_access_front_main
...
-- Dumping structure for view mtn_prod.shopping_center_access_non_main
...
-- Dumping structure for view mtn_prod.shopping_center_access_side_main
...
-- Dumping structure for view mtn_prod.shopping_center_condition_scores
...
-- Dumping structure for view mtn_prod.shopping_center_score
...
-- Dumping structure for view mtn_prod.shopping_center_score_card
...
-- Dumping structure for view mtn_prod.store_best_volume
...
-- Dumping structure for view mtn_prod.store_strength
...
-- Dumping structure for view mtn_prod.store_volume_actual
...
-- Dumping structure for view mtn_prod.store_volume_estimate
...
-- Dumping structure for view mtn_prod.store_volume_projection
...
-- Dumping structure for view mtn_prod.store_volume_reported
...
-- Dumping structure for view mtn_prod.store_volume_third_party
...
-- Dumping structure for view mtn_prod.volume_decision
...
-- Dumping structure for view mtn_prod.volume_decision_params
