...
-- Dumping structure for view mtn_rest.active_and_future_stores
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `active_and_future_stores` (
	...
	`volume_total` BIGINT(20) NULL,
	`volume_date` DATE NULL,
	`shopping_center_feature_score` BINARY(0) NULL,
	`rating_synergy` ENUM('POOR','FAIR','AVERAGE','GOOD','EXCELLENT') NULL COLLATE 'utf8mb4_general_ci',
	`tenant_vacant_count` INT(11) NULL,
	`tenant_occupied_count` INT(11) NULL,
	`parking_space_count` INT(11) NULL,
	`legacy_location_id` INT(10) NULL,
	`cbsa_id` INT(11) NULL,
	`sc_condition_score` DECIMAL(16,2) NULL,
	`volume_confidence` ENUM('LOW','MEDIUM','HIGH','VERY_HIGH') NULL COLLATE 'utf8_general_ci',
	`power` FLOAT NULL
) ENGINE=MyISAM;

-- Dumping structure for view mtn_rest.active_stores_with_strengths
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.average_sc_score
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.most_recent_shopping_center_casing
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `most_recent_shopping_center_casing` (
	...
	`shopping_center_casing_notes` TEXT NULL COLLATE 'utf8_general_ci',
	`rating_parking_lot` ENUM('POOR','FAIR','AVERAGE','GOOD','EXCELLENT') NULL COLLATE 'utf8mb4_general_ci',
	`rating_buildings` ENUM('POOR','FAIR','AVERAGE','GOOD','EXCELLENT') NULL COLLATE 'utf8mb4_general_ci',
	`rating_lighting` ENUM('POOR','FAIR','AVERAGE','GOOD','EXCELLENT') NULL COLLATE 'utf8mb4_general_ci',
	`rating_synergy` ENUM('POOR','FAIR','AVERAGE','GOOD','EXCELLENT') NULL COLLATE 'utf8mb4_general_ci',
	...
	`legacy_casing_id` INT(10) NULL
) ENGINE=MyISAM;

-- Dumping structure for view mtn_rest.most_recent_shopping_center_survey
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `most_recent_shopping_center_survey` (
	...
	`shopping_center_survey_notes` TEXT NULL COLLATE 'utf8_general_ci',
...
-- Dumping structure for view mtn_rest.most_recent_store_casing
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `most_recent_store_casing` (
	`store_casing_id` INT(11) NOT NULL,
	`store_id` INT(11) NOT NULL,
	`store_casing_date` DATE NULL,
	`store_casing_notes` TEXT NULL COLLATE 'utf8_general_ci',
	`store_status` VARCHAR(255) NULL COLLATE 'utf8_unicode_ci',
	`condition_ceiling` ENUM('POOR','FAIR','AVERAGE','GOOD','EXCELLENT') NULL COLLATE 'utf8mb4_general_ci',
	`condition_checkstands` ENUM('POOR','FAIR','AVERAGE','GOOD','EXCELLENT') NULL COLLATE 'utf8mb4_general_ci',
	`condition_floors` ENUM('POOR','FAIR','AVERAGE','GOOD','EXCELLENT') NULL COLLATE 'utf8mb4_general_ci',
	`condition_frozen_refrigerated` ENUM('POOR','FAIR','AVERAGE','GOOD','EXCELLENT') NULL COLLATE 'utf8mb4_general_ci',
	`condition_shelving_gondolas` ENUM('POOR','FAIR','AVERAGE','GOOD','EXCELLENT') NULL COLLATE 'utf8mb4_general_ci',
	`condition_walls` ENUM('POOR','FAIR','AVERAGE','GOOD','EXCELLENT') NULL COLLATE 'utf8mb4_general_ci',
	...
	`volume_notes` TEXT NULL COLLATE 'utf8_general_ci',
	`volume_total` INT(11) NULL,
	`volume_confidence` ENUM('LOW','MEDIUM','HIGH','VERY_HIGH') NULL COLLATE 'utf8_general_ci',
	`created_date` DATETIME NOT NULL,
	`created_by` INT(11) NOT NULL,
	`updated_date` DATETIME NOT NULL,
...
-- Dumping structure for view mtn_rest.most_recent_store_model
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `most_recent_store_model` (
	...
	`model_type` ENUM('BALANCE','TACTICAL') NOT NULL COLLATE 'utf8mb4_general_ci',
...
-- Dumping structure for view mtn_rest.most_recent_store_survey
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `most_recent_store_survey` (
	`store_survey_id` INT(11) NOT NULL,
	`store_id` INT(11) NULL,
	`store_survey_date` DATE NULL,
	`store_survey_notes` TEXT NULL COLLATE 'utf8_general_ci',
...
-- Dumping structure for view mtn_rest.most_recent_store_volume
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `most_recent_store_volume` (
	...
	`volume_type` VARCHAR(50) NOT NULL COLLATE 'utf8mb4_general_ci',
	`source` VARCHAR(164) NULL COLLATE 'utf8mb4_general_ci',
	`created_date` DATETIME NOT NULL,
	`created_by` INT(11) NOT NULL,
	`updated_date` DATETIME NOT NULL,
	`updated_by` INT(11) NOT NULL,
...
-- Dumping structure for view mtn_rest.most_recent_store_volume_actual
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `most_recent_store_volume_actual` (
	`store_volume_id` INT(11) NOT NULL,
	`store_id` INT(11) NOT NULL,
	`volume_total` BIGINT(12) NOT NULL,
	`volume_date` DATE NOT NULL,
	`volume_type` VARCHAR(50) NOT NULL COLLATE 'utf8mb4_general_ci',
	`source` VARCHAR(164) NULL COLLATE 'utf8mb4_general_ci',
	`created_date` DATETIME NOT NULL,
...
-- Dumping structure for view mtn_rest.most_recent_store_volume_estimate
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.most_recent_store_volume_projection
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.most_recent_store_volume_reported
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.most_recent_store_volume_third_party
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.sc_condition_global_avg_score
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `sc_condition_global_avg_score` (
	`average` DECIMAL(17,4) NULL
) ENGINE=MyISAM;

-- Dumping structure for view mtn_rest.sc_condition_index
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.sc_condition_score
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.shopping_center_access_front_main
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.shopping_center_access_non_main
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.shopping_center_access_side_main
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.shopping_center_condition_scores
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.shopping_center_score
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.shopping_center_score_card
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.store_best_volume
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.store_strength
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.store_volume_actual
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.store_volume_estimate
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.store_volume_projection
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.store_volume_reported
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.store_volume_third_party
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.volume_avg_by_banner_in_county
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `volume_avg_by_banner_in_county` (
	`banner_id` INT(11) NULL,
	`state` VARCHAR(255) NULL COLLATE 'utf8_unicode_ci',
	`county` VARCHAR(255) NULL COLLATE 'utf8_unicode_ci',
	`volume` DECIMAL(14,4) NULL,
	`volume_per_sqft` DECIMAL(18,8) NULL
) ENGINE=MyISAM;

-- Dumping structure for view mtn_rest.volume_avg_by_county
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `volume_avg_by_county` (
	`state` VARCHAR(255) NULL COLLATE 'utf8_unicode_ci',
	`county` VARCHAR(255) NULL COLLATE 'utf8_unicode_ci',
	`volume` DECIMAL(14,4) NULL,
	`volume_per_sqft` DECIMAL(18,8) NULL
...
-- Dumping structure for view mtn_rest.volume_avg_by_fit_in_county
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `volume_avg_by_fit_in_county` (
	`store_fit` VARCHAR(255) NULL COLLATE 'utf8_unicode_ci',
	`state` VARCHAR(255) NULL COLLATE 'utf8_unicode_ci',
	`county` VARCHAR(255) NULL COLLATE 'utf8_unicode_ci',
	`volume` DECIMAL(14,4) NULL,
...
-- Dumping structure for view mtn_rest.volume_decision
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view mtn_rest.volume_decision_params
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `volume_decision_params` (
	...
	`volume_actual` BIGINT(12) NULL,
	`volume_actual_date` DATE NULL,
	`volume_estimate` BIGINT(12) NULL,
	`volume_estimate_date` DATE NULL,
	`volume_projection` BIGINT(12) NULL,
	`volume_projection_date` DATE NULL,
	`volume_reported` BIGINT(12) NULL,
	`volume_reported_date` DATE NULL,
	`volume_third_party` BIGINT(12) NULL,
