...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		JwtWebSecurityConfigurer.forRS256(apiAudience, issuer, new MtnAuthenticationProvider()).configure(http)
				...
				.antMatchers(HttpMethod.DELETE, "/api/store-casing/**").hasAuthority(PermissionType.STORE_CASINGS_DELETE)
				.antMatchers(HttpMethod.POST, "/api/store-survey/**").hasAuthority(PermissionType.STORE_SURVEYS_CREATE)
				.antMatchers(HttpMethod.GET, "/api/store-survey/**").hasAuthority(PermissionType.STORE_SURVEYS_READ)
				.antMatchers(HttpMethod.PUT, "/api/store-survey/**").hasAuthority(PermissionType.STORE_SURVEYS_UPDATE)
				.antMatchers(HttpMethod.DELETE, "/api/store-survey/**").hasAuthority(PermissionType.STORE_SURVEYS_DELETE)
				.antMatchers(HttpMethod.POST, "/api/store-volume/**").hasAuthority(PermissionType.STORE_VOLUMES_CREATE)
				.antMatchers(HttpMethod.GET, "/api/store-volume/**").hasAuthority(PermissionType.STORE_VOLUMES_READ)
				.antMatchers(HttpMethod.PUT, "/api/store-volume/**").hasAuthority(PermissionType.STORE_VOLUMES_UPDATE)
				.antMatchers(HttpMethod.DELETE, "/api/store-volume/**").hasAuthority(PermissionType.STORE_VOLUMES_DELETE)
				.antMatchers(HttpMethod.POST, "/api/shopping-center/**").hasAuthority(PermissionType.SHOPPING_CENTERS_CREATE)
				.antMatchers(HttpMethod.GET, "/api/shopping-center/**").hasAuthority(PermissionType.SHOPPING_CENTERS_READ)
				.antMatchers(HttpMethod.PUT, "/api/shopping-center/**").hasAuthority(PermissionType.SHOPPING_CENTERS_UPDATE)
				.antMatchers(HttpMethod.DELETE, "/api/shopping-center/**").hasAuthority(PermissionType.SHOPPING_CENTERS_DELETE)
				.antMatchers(HttpMethod.POST, "/api/shopping-center-casing/**").hasAuthority(PermissionType.SHOPPING_CENTER_CASINGS_CREATE)
				.antMatchers(HttpMethod.GET, "/api/shopping-center-casing/**").hasAuthority(PermissionType.SHOPPING_CENTER_CASINGS_READ)
				.antMatchers(HttpMethod.PUT, "/api/shopping-center-casing/**").hasAuthority(PermissionType.SHOPPING_CENTER_CASINGS_UPDATE)
				.antMatchers(HttpMethod.DELETE, "/api/shopping-center-casing/**").hasAuthority(PermissionType.SHOPPING_CENTER_CASINGS_DELETE)
				.antMatchers(HttpMethod.POST, "/api/shopping-center-survey/**").hasAuthority(PermissionType.SHOPPING_CENTER_SURVEYS_CREATE)
				.antMatchers(HttpMethod.GET, "/api/shopping-center-survey/**").hasAuthority(PermissionType.SHOPPING_CENTER_SURVEYS_READ)
				.antMatchers(HttpMethod.PUT, "/api/shopping-center-survey/**").hasAuthority(PermissionType.SHOPPING_CENTER_SURVEYS_UPDATE)
				.antMatchers(HttpMethod.DELETE, "/api/shopping-center-survey/**").hasAuthority(PermissionType.SHOPPING_CENTER_SURVEYS_DELETE)
				.antMatchers(HttpMethod.POST, "/api/shopping-center-tenant/**").hasAuthority(PermissionType.SHOPPING_CENTER_SURVEYS_CREATE)
				.antMatchers(HttpMethod.GET, "/api/shopping-center-tenant/**").hasAuthority(PermissionType.SHOPPING_CENTER_SURVEYS_READ)
				.antMatchers(HttpMethod.PUT, "/api/shopping-center-tenant/**").hasAuthority(PermissionType.SHOPPING_CENTER_SURVEYS_UPDATE)
				.antMatchers(HttpMethod.DELETE, "/api/shopping-center-tenant/**").hasAuthority(PermissionType.SHOPPING_CENTER_SURVEYS_DELETE)
				.antMatchers(HttpMethod.POST, "/api/shopping-center-access/**").hasAuthority(PermissionType.SHOPPING_CENTER_SURVEYS_CREATE)
				.antMatchers(HttpMethod.GET, "/api/shopping-center-access/**").hasAuthority(PermissionType.SHOPPING_CENTER_SURVEYS_READ)
				.antMatchers(HttpMethod.PUT, "/api/shopping-center-access/**").hasAuthority(PermissionType.SHOPPING_CENTER_SURVEYS_UPDATE)
				.antMatchers(HttpMethod.DELETE, "/api/shopping-center-access/**").hasAuthority(PermissionType.SHOPPING_CENTER_SURVEYS_DELETE)
				...
				.antMatchers(HttpMethod.DELETE, "/api/banner-source/**").hasAuthority(PermissionType.STORE_SOURCE_DELETE)
				.antMatchers(HttpMethod.GET, "/api/site-wise/**").hasAuthority("SITE_WISE_READ")
				.antMatchers(HttpMethod.GET, "/api/commissary/**").hasAuthority("COMMISSARY_READ")
				.antMatchers(HttpMethod.GET, "/api/map-box/**").hasAuthority("MAP_BOX_READ")
				.antMatchers(HttpMethod.GET, "/api/gravity/**").permitAll()
				.antMatchers(HttpMethod.GET, "/api/planned-grocery/**").authenticated()
				.antMatchers(HttpMethod.POST, "/api/planned-grocery/**").authenticated()
				...
				.antMatchers(HttpMethod.DELETE, "/api/user-boundary/**").authenticated()
				.antMatchers(HttpMethod.POST, "/api/user-boundary/**").authenticated()
				.antMatchers(HttpMethod.PUT, "/api/user-boundary/**").authenticated()
				...
				.antMatchers(HttpMethod.PUT, "/api/boundary/**").authenticated()
				.anyRequest().denyAll();
	}
