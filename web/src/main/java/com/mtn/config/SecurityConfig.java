...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        JwtWebSecurityConfigurer
                ...
                .antMatchers(HttpMethod.POST, "/api/company/**").hasAuthority(PermissionType.COMPANIES_CREATE)
                .antMatchers(HttpMethod.GET, "/api/company/**").hasAuthority(PermissionType.COMPANIES_READ)
                .antMatchers(HttpMethod.PUT, "/api/company/**").hasAuthority(PermissionType.COMPANIES_UPDATE)
