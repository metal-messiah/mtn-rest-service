...
public class StoreListController extends CrudController<Project, ProjectView> {
	...
	@Autowired
	public StoreListController(ProjectService projectService, BoundaryService boundaryService,
			StoreService storeService, StoreCasingService storeCasingService) {
