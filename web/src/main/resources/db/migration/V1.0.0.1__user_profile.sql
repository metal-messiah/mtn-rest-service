...
CREATE INDEX idx_user_identity_user_profile_id ON user_identity (user_profile_id);
CREATE INDEX idx_user_identity_provider_user_id_provider ON user_identity (provider_user_id, provider);