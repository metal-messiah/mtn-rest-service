...
CREATE INDEX idx_shopping_center_name
  ON shopping_center (name);
CREATE INDEX idx_shopping_center_native_id
  ON shopping_center (native_id);
CREATE INDEX idx_shopping_center_owner
  ON shopping_center (owner);